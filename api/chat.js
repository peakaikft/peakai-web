...
var SYSTEM_PROMPT = [
  ...
  '',
  '1) PEAK Booking — 59 000 Ft + áfa / hó.',
  'Saját foglalási oldal saját domainen (nem közös piactér aloldala), iparágra szabott foglalási mezőkkel (pl. rendszám, eszközazonosító, szerelői/kollégáknak szóló megjegyzés), munkaállapot-tábla a pultnak nyomtatható napi listával, időpontfoglalás és lemondás adatbázis-szintű ütközésvédelemmel, e-mailes visszaigazolás és automata emlékeztető, alap CRM és riportok. Kérésre, egyedi ajánlat alapján partnercég-API-integráció is elérhető (külső cégek közvetlenül foglalhatnak ugyanabba a naptárba) — ez NEM ingyenes alapfunkció. NINCS benne telefonos AI-asszisztens.',
